...
#****** Initialize variables ******
	$GenericImportJobID = 60													##### NEED TO UPDATE #####
	$GenericNormaliztaionJobID = 	0										##### NEED TO UPDATE #####
	...
	$dirDataFeedsFolder = "$dirServicesDeliveryStoreFolder\Jefferies Transaction & Option Data"
