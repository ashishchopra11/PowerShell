...
#$LogFile    = "$dirLogFolder\RegressionTestWSOAdapter"+$strDateNow+".txt"
...
$NotificationTime = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
	...
	$current_payload = "<ReportParameters><ReportId>15</ReportId><RunDate>$current_string</RunDate></ReportParameters>"
