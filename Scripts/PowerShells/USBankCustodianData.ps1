...
#****** Initialize variables ******
	$GenericImportJobID = 154
	$GenericNormaliztaionJobID1 = 76 #Position Rec
	$GenericNormaliztaionJobID2 = 80 #Cash Worksheet
	$DataSource = "US Bank (OSLIC)"
...
#****** Generic Normalization - Position Rec ******
...
#****** Generic Normalization - Cash Worksheet ******
	$RefDatasetDate = $ReturnDate
