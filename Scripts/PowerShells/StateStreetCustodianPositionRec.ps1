...
#################################################################################### 
	...
	$ExtractFrom = '\\services.hcmlp.com\DeliveryStore\StateStreet\Position Files - Cust\attachment.zip'
	$ExtractTo = '\\services.hcmlp.com\DeliveryStore\StateStreet\Position Files - Cust\'
...
#****** Initialize variables ******
	$GenericImportJobID = 46													##### NEED TO UPDATE #####
	$GenericNormaliztaionJobID = 43											##### NEED TO UPDATE #####
	...
	$RefDataSetDate = fOffsetDate (get-date).toShortDateString() 'T' '-' 2
